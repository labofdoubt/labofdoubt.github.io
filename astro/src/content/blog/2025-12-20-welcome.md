...
\end{equation}
$$
Eq. [(2)](#eq-variance-recursion) can thus be interpreted as a consequence of applying the Pythagorean theorem to the three vectors in Eq. [(1)](#eq-residual-update), which become orthogonal in the large-width limit. This reduction of the dynamics to tracking the single quantity $\mathcal{K}_l$ is often referred to as mean-field theory at initialization.
