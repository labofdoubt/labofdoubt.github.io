...
<figure id="fig-alpha-transition" class="wide">
...
<figure id="fig-alpha-transitions" class="wide">
  <img src="/figures/FIGURE1.svg" alt="Transition depth as a function of alpha (placeholder)." />
  <figcaption><strong>Figure 1.</strong> Placeholder caption: transition to stretched-exponential gradient growth happens earlier as \( \alpha \) increases.</figcaption>
</figure>
