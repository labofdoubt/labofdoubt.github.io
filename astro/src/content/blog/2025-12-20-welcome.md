...
**Figure 1.**  **(a)**  $ \mathcal{K}_l $ vs. $l$; **(b)** $ \mathcal{J}^{L, l} $ vs. $l$. 
...
% Similar to post-LN Transformers, which suffer from vanishing gradients and benefit from learning-rate warm-up [Ref.], $\text{DyT}$ Transformers benefit from warm-up as well.
