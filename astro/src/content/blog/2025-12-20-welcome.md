...
<figure id="fig-vit-grads" class="wide">
  <img src="/figures/vit_grads_1.svg" alt="Transition depth as a function of alpha (placeholder)." />
  <figcaption><strong>Figure 1.</strong> Placeholder caption: transition to stretched-exponential gradient growth happens earlier as \( \alpha \) increases.</figcaption>
</figure>

<figure id="fig-vit-grads-2" class="wide">
  <img src="/figures/vit_grads_2.svg" alt="Transition depth as a function of alpha (placeholder)." />
  <figcaption><strong>Figure 1.</strong> Placeholder caption: transition to stretched-exponential gradient growth happens earlier as \( \alpha \) increases.</figcaption>
</figure>
